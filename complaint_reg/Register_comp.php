...
?>
    ...
    <hr>
    <form action="Register_com_process.php" method="POST" id="passwordForm" enctype="multipart/form-data">
    ...
    <label for="complaintImage">Upload Image:</label>(*Note: Only '.JPG' , '.PNG' allowed)<img src='../images/giphy1.gif' style='width:3%'><br>   
    <input type="file" class="form-control" name="complaintImage" id="complaintImage" accept="image/*"  disabled>
    <br>
